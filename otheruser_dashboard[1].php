...
<style>
    body {
        font-family: 'Roboto';
        background-image: url("image/Digital-Library.png");
    ...
    <div class="container">
        <div class="innerdiv">
            <div class="leftinnerdiv">
                <div class="row"><img class="imglogo" src="image\th.jpg"></div>
                <br>
            ...
            <div class="rightinnerdiv">
                <div id="myaccount" class="innerright portion" style="display:none">
                <?php
                    $u = new data;
                    $u->setconnection();
